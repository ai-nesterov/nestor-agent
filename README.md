...
[![Version 4.9.4](https://img.shields.io/badge/version-4.9.4-green.svg)](VERSION)
...
| 4.9.3 | 2026-04-02 | Fix evolution report_only loop: add early checkpoint at round 5 for evolution tasks (ouroboros/loop.py). Before this fix, evolution cycles 10-17 ran 0-6 tool calls and ended as reports. The model spent 14 rounds doing nothing before the first soft checkpoint at round 15. Early checkpoint forces immediate file read/write. |
