...
def ensure_state_defaults(st: Dict[str, Any]) -> Dict[str, Any]:
    ...
    st.setdefault("evolution_last_outcome", "")
    st.setdefault("evolution_last_outcome_at", "")
    st.setdefault("evolution_waiting_for_owner", False)
    st.setdefault("evolution_blocked_reason", "")
